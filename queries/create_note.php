    ...
    $end_date = new DateTime('today');
        ...
        <?php if ($diff > 0 && $data != NULL) { echo "<div class=\"due\">Days left <b>$diff</b></div>"; } else {}; ?>
           ...
           <div class="buttonshide" id="<?php echo $data['noteID']; ?>">
             <button class="clickme edit" onclick="edit(this)" id="<?php echo $data['noteID']; ?>"><img src="./icons/edit.png" title="Edit note" alt="edit note"></button>
             <button class="clickme delete" onclick="delete_note(this)" id="<?php echo $data['noteID']; ?>"><img src="./icons/close.png" title="DELETE note" alt="delete note"></button>
           </div>
       </li>
    <?php endwhile; ?>
